...
export const MODEL_PRESETS: { provider: string; models: { id: string; name: string; maxTokens: number; contextWindow: number }[] }[] = [
  {
    provider: 'openai',
    models: [
      { id: 'gpt-5.5', name: 'GPT-5.5', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'gpt-5.5-pro', name: 'GPT-5.5 Pro', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'gpt-5.4', name: 'GPT-5.4', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'gpt-5.4-mini', name: 'GPT-5.4 Mini', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'gpt-5.4-nano', name: 'GPT-5.4 Nano', maxTokens: 16384, contextWindow: 1048576 },
      { id: 'gpt-5.4-pro', name: 'GPT-5.4 Pro', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'gpt-5.3-codex', name: 'GPT-5.3 Codex', maxTokens: 32768, contextWindow: 1048576 },
  ...
  },
  {
    provider: 'google',
    models: [
      { id: 'gemini-3.1-pro', name: 'Gemini 3.1 Pro (preview)', maxTokens: 65536, contextWindow: 1048576 },
      { id: 'gemini-3-flash', name: 'Gemini 3 Flash (preview)', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash-Lite (preview)', maxTokens: 32768, contextWindow: 1048576 },
      ...
      { id: 'gemini-2.5-flash-lite', name: 'Gemini 2.5 Flash-Lite', maxTokens: 32768, contextWindow: 1048576 },
  ...
  },
  {
    provider: 'openrouter',
    models: [
      { id: 'openai/gpt-5.5', name: 'GPT-5.5', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'openai/gpt-5.4', name: 'GPT-5.4', maxTokens: 32768, contextWindow: 1048576 },
      { id: 'openai/gpt-5.4-mini', name: 'GPT-5.4 Mini', maxTokens: 32768, contextWindow: 1048576 },
      ...
      { id: 'google/gemini-3.1-pro', name: 'Gemini 3.1 Pro', maxTokens: 65536, contextWindow: 1048576 },
      { id: 'google/gemini-3-flash', name: 'Gemini 3 Flash', maxTokens: 32768, contextWindow: 1048576 },
